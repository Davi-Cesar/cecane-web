    ...
    <>
      ...
      <div className={styles.Container}>
        ...
        <div className={styles.Content}>
          <h4>Produto 1:</h4>
          <p>
            Fornecer suporte técnico ao FNDE no planejamento e execução de ações
            que contribuam para o fortalecimento do controle social com foco no
            desenvolvimento de atividades voltadas para o aprimoramento dos
            conselheiros de alimentação escolar por meio de eventos de formação
            e capacitação e na melhoria da interlocução entre FNDE e os
            conselheiros de alimentação escolar, além de possibilitar o
            intercâmbio de conhecimentos ao facilitar a articulação entre o
            Centro Colaborador de Alimentação e Nutrição Escolar (CECANE) e o
            FNDE.
          </p>
          <h4>Produto 2:</h4>
          <p>
          ...
          <p>
            ...
            alimentação escolar com a oferta da produção da agricultura familiar
            para o bom atendimento da Resolução do PNAE, sobretudo pelo
            preconizado pelo Art.14 da Lei 11.947.
          </p>
          <h4>Produto 4:</h4>
          <p>
